    ...
    try {
        ...
        if(forecast[0].day.condition.text == 'Sunny'){
            document.body.style.cssText = `
                background-image: linear-gradient(to right, #000000a2 50%, #000000a2 100%), url('image/0093830f1dd6e42c6137ee1eb8e3286b_w200.gif');
                background-size: cover;
                background-position: center center;
            `
        }else if(forecast[0].day.condition.text == 'Heavy rain'){
            document.body.style.cssText = `
                background-image: linear-gradient(to right, #000000a2 50%, #000000a2 100%),url('image/rain.gif');
                background-size: cover;
                background-position: center center;
            `
            ...
            document.body.style.cssText = `
            background-image: linear-gradient(to right, #000000a2 50%, #000000a2 100%), url('image/Light drizzle.gif');
            background-size: cover;
            background-position: center center;
            `
            ...
            document.body.style.cssText = `
                background-image: linear-gradient(to right, #000000a2 50%, #000000a2 100%), url('image/nav-bg.gif');
                background-size: cover;
                background-position: center center;
            `
        } else if(forecast[0].day.condition.text == 'Snowy' || forecast[0].day.condition.text == 'Snow'){
            document.body.style.cssText = `
            background-image: linear-gradient(to right, #000000a2 50%, #000000a2 100%), url('image/snowy.gif');
            background-size: cover;
            background-position: center center;
            `
        } else{
